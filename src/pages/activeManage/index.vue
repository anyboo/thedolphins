<template>
    <div class="allActive">
        ...
        <el-card class="box-card">
            ...
            <el-table :data="filteredTableData" selection-mode="multiple" style="width: 100%" @cellclick="handleSelect" @selectionchange="selectionchange" :custom-criteria="['$info', '$positive']" :custom-background-colors="['#C9E5F5', '#E2F0E4']">
            ...
            <el-row type="flex" justify="end" style="padding:20px 0; ">
                <el-pagination @sizechange="pageSizechange" @currentchange="pageCurrentchange" :current-page="5" :page-sizes="[100, 200, 300, 400]" :page-size="100" layout="sizes, prev, pager, next" :total="1000">
                </el-pagination>
            </el-row>
        </el-card>
    </div>
