<template>
    <div class="page5">
        <el-card class="box-card">
            ...
            <el-row>
                <el-table :data="tableData" selection-mode="multiple" @selectionchange="selectionchange" @cellclick="handleSelect" :custom-criteria="['$info', '$positive']" :custom-background-colors="['#C9E5F5', '#E2F0E4']">
            ...
            <el-row type="flex" align="middle" justify="end" style="padding: 20px 0;">
                <el-pagination @sizechange="" @currentchange="" :current-page="1" :page-sizes="[100, 200, 300, 400]" :page-size="100" layout="sizes, prev, pager, next" :total="totalItemsNum">
                </el-pagination>
            </el-row>
        </el-card>
    </div>
